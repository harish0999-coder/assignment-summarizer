...
export default function AnalyzePage({ onNavigate }) {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      setError(err.message.includes("fetch") ? "Cannot reach backend. Is the server running on port 3001?" : err.message);
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <div style={s.page}>
        ...
        <div style={s.panel}>
          ...
          <button
            style={{
              ...
              background: isReady
                ? "linear-gradient(135deg, #f0c060, #00e5cc)"
      ...
      <footer style={s.footer}>
        Lumina AI · React + Groq · Results are AI-generated
      </footer>
    </div>
  );
}
...
const s = {
  page: {
    ...
    background: "radial-gradient(ellipse 100% 50% at 50% -10%, #0e0730 0%, #03020a 55%)",
  },
  orb1: {
  ...
  backBtn: {
    ...
    color:"var(--text2)", padding:"8px 18px", borderRadius:99,
    fontSize:13, cursor:"pointer", fontFamily:"var(--font-body)",
    transition:"all 0.15s",
  },
  brand: { display:"flex", alignItems:"center", gap:10 },
  brandName: {
    fontFamily:"var(--font-head)", fontSize:22, letterSpacing:"0.1em",
    background:"linear-gradient(90deg,#f0c060,#00e5cc)",
    WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent",
  },
  headerRight: { display:"flex", alignItems:"center", gap:8 },
  statusDot: {
    width:8, height:8, borderRadius:"50%", background:"var(--pos)",
    boxShadow:"0 0 8px var(--pos)",
  },
  statusText: { fontFamily:"var(--font-mono)", fontSize:11, color:"var(--pos)" },
  titleRow: {
    textAlign:"center", padding:"4px 24px 28px",
    position:"relative", zIndex:5,
    animation:"fadeUp 0.5s ease both",
  },
  pageTitle: {
    fontFamily:"var(--font-head)", fontSize:52, letterSpacing:"0.05em",
    background:"linear-gradient(90deg, #f0eeff, rgba(240,240,255,0.5))",
    WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent",
    lineHeight:1,
  },
  ...
  exBtn: {
    ...
    color:"var(--text2)", padding:"3px 10px", borderRadius:99,
  ...
  textarea: {
    ...
    fontSize:13, lineHeight:1.8, padding:"16px 16px 40px",
  },
  charBadge: {
  ...
  submitBtn: {
    margin:"16px", borderRadius:12, border:"none",
    padding:"14px", fontFamily:"var(--font-body)",
    fontWeight:700, fontSize:15, transition:"transform 0.15s",
  ...
  emptyIcon: {
    fontSize:40, color:"var(--purple)", lineHeight:1, position:"relative",
  },
  emptyTitle: {
    fontFamily:"var(--font-head)", fontSize:20, letterSpacing:"0.05em",
  ...
  doneTag: {
    fontFamily:"var(--font-mono)", fontSize:10, color:"var(--pos)",
    background:"rgba(34,212,138,0.1)", padding:"3px 10px",
    borderRadius:99, border:"1px solid rgba(34,212,138,0.2)",
  },
  footer: {
    fontFamily:"var(--font-mono)", fontSize:10, color:"var(--text3)",
    padding:"16px", textAlign:"center", letterSpacing:"0.06em",
    position:"relative", zIndex:5,
  },
};
